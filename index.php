    ...
    <body>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="image-change">
                    <h2 class="wow fadeInUp animated">RMIT University</h2>
                    <h5 class="wow fadeIn animated" data-wow-delay="0.2s">Buy Now At The RMIT Store</h5>
                    <a class="learn-more wow fadeInU" data-wow-delay="0.3s" href="#item-list">Buy this Now!</a>
                </div>
            </div>
        </section>
        <!--==========Slider Section==========-->
        ...
        <section class="rmit-store-section row">
            ...
            <div class="row rmit-product-section">
              <?php
              $link = mysqli_connect(
                  "rmit-store-db.cdzoafclo9fs.us-east-1.rds.amazonaws.com",
                  "db_admin",
                  "rmit_password",
                  "rmit_store_db"
              );
